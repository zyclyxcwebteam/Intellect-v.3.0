    ...
    >
      <Container fluid className="d-flex justify-content-center">
        <Container className="p-5 mx-5 sitemap">
          ...
          <p>Welcome to INTELLECT Technologies!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of INTELLECT Technologies's Website, located at
            https://www.intellect-qa.com/.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use INTELLECT Technologies if you do
          ...
          <p>
            We employ the use of cookies. By accessing INTELLECT Technologies,
            you agreed to use cookies in agreement with the INTELLECT
          ...
          <p>
            Unless otherwise stated, INTELLECT Technologies and/or its licensors
            own the intellectual property rights for all material on INTELLECT
            Technologies. All intellectual property rights are reserved. You may
            access this from INTELLECT Technologies for your own personal use
            subjected to restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from INTELLECT Technologies</li>
            <li>
              Sell, rent or sub-license material from INTELLECT Technologies
            </li>
            <li>
              Reproduce, duplicate or copy material from INTELLECT Technologies
            </li>
            <li>Redistribute content from INTELLECT Technologies</li>
          </ul>
          ...
          <p>
            ...
            INTELLECT Technologies does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of INTELLECT Technologies,its agents
            ...
            applicable laws, INTELLECT Technologies shall not be liable for the
          ...
          <p>
            INTELLECT Technologies reserves the right to monitor all Comments
          ...
          <p>
            You hereby grant INTELLECT Technologies a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of INTELLECT
            Technologies; and (d) the link is in the context of general resource
            information.
          </p>
          ...
          <p>
            ...
            sending an e-mail to INTELLECT Technologies. Please include your
          ...
          <p>
            No use of INTELLECT Technologies&apos;s logo or other artwork will
